...
public class FindBusServiceDetailsAdapter extends BaseExpandableListAdapter {
    ...
    public FindBusServiceDetailsAdapter(Context context, List<String> listDataHeader,

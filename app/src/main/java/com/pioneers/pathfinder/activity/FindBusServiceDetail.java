...
public class FindBusServiceDetail extends Activity { // For Test Commit

    public static FindBusServiceDetail instance = null;
    Context context;
    FindBusServiceDetailsAdapter listAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_findbusservicedetail);
        context = this;
        instance = this;
        ...
        if (reqType.equals(getString(R.string.shortestPath))) {
            ...
            shortestPathDbRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    listAdapter = new FindBusServiceDetailsAdapter(getBaseContext(), listPathHeader, listPathDetails);
